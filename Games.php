...
<div class="nav nav_close">
        ...
        <section>
            <p>Desde RPGs épicos hasta intensos shooters, esta sección es tu enciclopedia de juegos.</p>
        </section>
    </main>
    <script>
        function filterGames() {
            let category = prompt("¿Qué categoría te interesa? (Ejemplo: RPG, Shooter, Puzzle)");
            alert("Mostrando juegos en la categoría: " + category);
        }
    </script>
    <button onclick="filterGames()">Filtrar juegos</button>
